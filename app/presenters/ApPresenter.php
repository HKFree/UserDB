...
class ApPresenter extends BasePresenter {    
    ...
    protected function createComponentApForm() {
        ...
        $form->addText('gps', 'GPS souřadnice', 30)->setRequired('GPS souřadnice na Google mapě. Zeměpisná šířka jako reálné číslo, čárka, zeměpisná délka jako reálné číslo. Např. 50.22795,15.834133');
