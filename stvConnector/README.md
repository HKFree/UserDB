...
## downloadStvUserReport.py

Stahuje [`report-users` ze SledovaniTV API](https://redoc.moderntv.app/?url=https://sledovanitv.cz/partner/api/_/apidoc#operation/get-report-users) (seznam hkfree-uid, která v daném měsíci využila službu)
...
```shell
stv-connector:/opt# ./downloadStvUserReport.py
```
